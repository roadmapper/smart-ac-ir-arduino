...
unsigned const int irPower[] = { 8350, 4300, 450, 1700, 450, 1650, 450, 1650, 450, 650, 450, 1650, 450, 650, 400, 1700, 400, 1700, 450, 4300, 400, 1700, 450, 1650, 450, 650, 400, 1700, 450, 650, 400, 650, 400, 650, 450, 650, 500 };
unsigned const int irCool[] = { 8350, 4350, 450, 1650, 450, 1650, 450, 1700, 450, 600, 450, 1650, 450, 650, 400, 1700, 450, 1650, 450, 4300, 450, 650, 400, 700, 350, 700, 400, 650, 400, 700, 350, 700, 400, 650, 400, 700, 450 };
unsigned const int irFan[] = { 8400, 4300, 400, 1700, 450, 1650, 450, 1700, 400, 700, 350, 1700, 450, 650, 450, 1650, 400, 1700, 450, 4300, 450, 1650, 450, 650, 400, 650, 400, 700, 400, 650, 450, 600, 450, 650, 400, 650, 500 };
unsigned const int irTempInc[] = { 8400, 4300, 450, 1700, 400, 1700, 450, 1700, 400, 700, 350, 1700, 450, 650, 400, 1700, 400, 1700, 450, 4300, 400, 700, 400, 650, 400, 1700, 450, 650, 400, 650, 400, 650, 450, 650, 400, 650, 500 };
unsigned const int irTempDec[] = { 8400, 4350, 400, 1700, 450, 1650, 450, 1700, 450, 650, 400, 1650, 450, 650, 450, 1650, 450, 1650, 450, 4300, 450, 1650, 450, 650, 400, 1700, 450, 650, 400, 700, 350, 700, 400, 650, 400, 700, 450 };
...
#define AIO_SERVERPORT  1883                   // use 8883 for SSL, 1883 for non-SSL
...
void loop() {
  ...
  if (buttonState == LOW) {
    ...
    if (inputString.equals("power")) {
      ...
      irsend.sendRaw(irCool, sizeof(irCool) / sizeof(irCool[0]), 38);
    } else if (inputString.equals("fan")) {
      irsend.sendRaw(irFan, sizeof(irFan) / sizeof(irFan[0]), 38);
    } else if (inputString.equals("temp+")) {
      irsend.sendRaw(irTempInc, sizeof(irTempInc) / sizeof(irTempInc[0]), 38);
    } else if (inputString.equals("temp-")) {
      irsend.sendRaw(irTempDec, sizeof(irTempDec) / sizeof(irTempDec[0]), 38);
    } else {
